...
const GetDatabaseTopologyCommand_js_1 = require("../ServerWide/Commands/GetDatabaseTopologyCommand.js");
...
const HttpCache_js_1 = require("./HttpCache.js");
const index_js_1 = require("../Exceptions/index.js");
const GetClientConfigurationOperation_js_1 = require("../Documents/Operations/Configuration/GetClientConfigurationOperation.js");
const CurrentIndexAndNode_js_1 = require("./CurrentIndexAndNode.js");
const Constants_js_1 = require("../Constants.js");
const PromiseUtil_js_1 = require("../Utility/PromiseUtil.js");
const GetStatisticsOperation_js_1 = require("../Documents/Operations/GetStatisticsOperation.js");
...
const PromiseUtil_js_2 = require("../Utility/PromiseUtil.js");
const StringUtil_js_1 = require("../Utility/StringUtil.js");
const node_events_1 = require("node:events");
const SessionEvents_js_1 = require("../Documents/Session/SessionEvents.js");
const TimeUtil_js_1 = require("../Utility/TimeUtil.js");
const UpdateTopologyParameters_js_1 = require("./UpdateTopologyParameters.js");
const node_crypto_1 = require("node:crypto");
const DatabaseHealthCheckOperation_js_1 = require("../Documents/Operations/DatabaseHealthCheckOperation.js");
const GetNodeInfoCommand_js_1 = require("../ServerWide/Commands/GetNodeInfoCommand.js");
const Semaphore_js_1 = require("../Utility/Semaphore.js");
const OsUtil_js_1 = require("../Utility/OsUtil.js");
const ImportUtil_js_1 = require("../Utility/ImportUtil.js");
const DEFAULT_REQUEST_OPTIONS = {};
const log = (0, LogUtil_js_1.getLogger)({ module: "RequestExecutor" });
...
class NodeStatus {
    ...
    requestExecutor;
    _timer;
    constructor(node, requestExecutor, nodeStatusCallback) {
        this.node = node;
    ...
    startTimer() {
        this._timer = new Timer_js_1.Timer(() => {
...
class RequestExecutor {
     ...
     */
    static GLOBAL_APPLICATION_IDENTIFIER = null;
    static INITIAL_TOPOLOGY_ETAG = -2;
    _log;
    static CLIENT_VERSION = "7.0.0";
    _updateDatabaseTopologySemaphore = new Semaphore_js_1.Semaphore();
    _updateClientConfigurationSemaphore = new Semaphore_js_1.Semaphore();
    static _backwardCompatibilityFailureCheckOperation = new GetStatisticsOperation_js_1.GetStatisticsOperation("failure=check");
    static _failureCheckOperation = new DatabaseHealthCheckOperation_js_1.DatabaseHealthCheckOperation();
    static _useOldFailureCheckOperation = new Set();
    _failedNodesTimers = new Map();
    _databaseName;
    _certificate = null;
    ...
    /*
      ...
      see: https://github.com/cloudflare/miniflare/issues/292
    */
    static KEEP_ALIVE_HTTP_AGENT = null;
    static HTTPS_AGENT_CACHE = new Map();
    ...
    set firstTopologyUpdatePromise(value) {
        ...
        if (value) {
            this._firstTopologyUpdateStatus = PromiseUtil_js_2.PromiseStatusTracker.track(value);
        }
    }
    ...
    _disableClientConfigurationUpdates;
    _topologyHeaderName = Constants_js_1.HEADERS.TOPOLOGY_ETAG;
    _lastServerVersion;
    _customHttpRequestOptions;
    _defaultRequestOptions;
    static requestPostProcessor = null;
    ...
    _onFailedRequestInvoke(url, e, req, response) {
        const args = new SessionEvents_js_1.FailedRequestEventArgs(this._databaseName, url, e, req, response);
    ...
    static async createAgent(options) {
        try {
            let UndiciAgent;
            try {
                const undiciModule = await import((0, ImportUtil_js_1.importFix)("undici"));
    ...
    constructor(database, authOptions, conventions) {
        this._log = (0, LogUtil_js_1.getLogger)({
            module: `${this.constructor.name}-${Math.floor(Math.random() * 10000)}`
        });
        this._cache = new HttpCache_js_1.HttpCache(conventions.maxHttpCacheSize);
        this._databaseName = database;
        this._lastReturnedResponse = new Date();
        this._conventions = conventions.clone();
        this._authOptions = authOptions;
        this._certificate = Certificate_js_1.Certificate.createFromOptions(this._authOptions);
        this._setDefaultRequestOptions();
    ...
    static create(initialUrls, database, opts) {
        ...
        executor.firstTopologyUpdatePromise.catch(TypeUtil_js_1.TypeUtil.NOOP);
        return executor;
    }
    static getGlobalApplicationIdentifier() {
        ...
        if (!this.GLOBAL_APPLICATION_IDENTIFIER) {
            this.GLOBAL_APPLICATION_IDENTIFIER = (0, node_crypto_1.randomUUID)();
        }
    ...
    static createForSingleNodeWithoutConfigurationUpdates(url, database, opts) {
        ...
        const executor = new RequestExecutor(database, authOptions, documentConventions);
        const topology = new Topology_js_1.Topology();
        topology.etag = -1;
        const serverNode = new ServerNode_js_1.ServerNode({
            url: initialUrls[0],
            database,
            serverRole: "Member"
        });
        topology.nodes = [serverNode];
        executor._nodeSelector = new NodeSelector_js_1.NodeSelector(topology);
    ...
    async _updateClientConfiguration(serverNode) {
        ...
        try {
            semAcquiredContext = (0, SemaphoreUtil_js_1.acquireSemaphore)(this._updateClientConfigurationSemaphore);
    ...
    async _updateClientConfigurationInternal(serverNode) {
        ...
        try {
            ...
            const command = new GetClientConfigurationOperation_js_1.GetClientConfigurationCommand();
    ...
    async updateTopology(parameters) {
        ...
        const acquiredSemContext = (0, SemaphoreUtil_js_1.acquireSemaphore)(this._updateDatabaseTopologySemaphore, { timeout: parameters.timeoutInMs });
        try {
            ...
            const getTopology = new GetDatabaseTopologyCommand_js_1.GetDatabaseTopologyCommand(parameters.debugTag, this.conventions.sendApplicationIdentifier ? parameters.applicationIdentifier : null);
            ...
            if (!this._nodeSelector) {
                this._nodeSelector = new NodeSelector_js_1.NodeSelector(topology);
    ...
    chooseNodeForRequest(cmd, sessionInfo) {
        if (!StringUtil_js_1.StringUtil.isNullOrWhitespace(cmd.selectedNodeTag)) {
            ...
            for (const node of promotables) {
                if (node.clusterTag === cmd.selectedNodeTag) {
                    return new CurrentIndexAndNode_js_1.default(null, node);
                }
            }
        ...
        switch (this.conventions.readBalanceBehavior) {
            ...
            default: {
                (0, index_js_1.throwError)("NotSupportedException", `Invalid read balance behavior: ${this.conventions.readBalanceBehavior}`);
            }
        }
    }
        ...
        try {
            if (!this.firstTopologyUpdatePromise) {
                if (!this._lastKnownUrls) {
                    // shouldn't happen
                    (0, index_js_1.throwError)("InvalidOperationException", "No known topology and no previously known one, cannot proceed, likely a bug");
                }
                if (!this._disableTopologyUpdates) {
    ...
    _updateTopologyCallback() {
        ...
        const updateParameters = new UpdateTopologyParameters_js_1.UpdateTopologyParameters(serverNode);
    ...
    async _singleTopologyUpdateAsync(initialUrls, applicationIdentifier) {
        ...
        const topology = new Topology_js_1.Topology(this._topologyEtag, []);
        for (const url of initialUrls) {
            ...
            try {
                const command = new GetNodeInfoCommand_js_1.GetNodeInfoCommand();
                await this.execute(command, null, {
                    chosenNode: serverNode,
                    shouldRetry: false,
                    nodeIndex: null
    ...
    async _firstTopologyUpdate(inputUrls, applicationIdentifier) {
        ...
        const tryUpdateTopology = async (url, database) => {
            const serverNode = new ServerNode_js_1.ServerNode({ url, database, serverRole: "Member" });
            try {
                const updateParameters = new UpdateTopologyParameters_js_1.UpdateTopologyParameters(serverNode);
                updateParameters.timeoutInMs = TypeUtil_js_1.TypeUtil.MAX_INT32;
    ...
    _throwExceptions(details) {
        (0, index_js_1.throwError)("InvalidOperationException", "Failed to retrieve database topology from all known nodes"
            + OsUtil_js_1.EOL + details);
    }
    static validateUrls(initialUrls, authOptions) {
        ...
        for (let index = 0; index < initialUrls.length; index++) {
            ...
            (0, UriUtil_js_1.validateUri)(url);
        ...
        for (const url of initialUrls) {
            ...
            if (authOptions && authOptions.certificate) {
                (0, index_js_1.throwError)("InvalidOperationException", "The url " + url + " is using HTTP, but a certificate is specified, which require us to use HTTPS");
            }
            (0, index_js_1.throwError)("InvalidOperationException", "The url " + url
    ...
    _initializeUpdateTopologyTimer() {
        ...
        this._updateTopologyTimer =
            new Timer_js_1.Timer(() => this._updateTopologyCallback(), minInMs, minInMs);
    }
    async _executeOnSpecificNode(// this method is called `execute` in c# and java code
    command, sessionInfo = null, options = null) {
        ...
        this._emitter.emit("beforeRequest", new SessionEvents_js_1.BeforeRequestEventArgs(this._databaseName, url, req, attemptNum));
        ...
        if (response.status < 400 || command.statusCode === 304) {
            command.etag = (0, HttpUtil_js_1.getEtagHeader)(response) ?? cachedChangeVector;
        }
        let responseDispose = "Automatic";
        try {
            if (response.status === StatusCode_js_1.StatusCodes.NotModified) {
                this._emitter.emit("succeedRequest", new SessionEvents_js_1.SucceedRequestEventArgs(this._databaseName, url, response, req, attemptNum));
            ...
            if (response.status >= 400) {
                ...
                if (!unsuccessfulResponseHandled) {
                    const dbMissingHeader = response.headers.get(Constants_js_1.HEADERS.DATABASE_MISSING);
                    if (dbMissingHeader) {
                        (0, index_js_1.throwError)("DatabaseDoesNotExistException", dbMissingHeader);
                    }
    ...
    async _refreshIfNeeded(chosenNode, response) {
        const refreshTopology = response
            && response.headers
            && response.headers.get(Constants_js_1.HEADERS.REFRESH_TOPOLOGY);
        const refreshClientConfiguration = response
            && response.headers
            && response.headers.get(Constants_js_1.HEADERS.REFRESH_CLIENT_CONFIGURATION);
        const tasks = [];
        if (refreshTopology) {
            const updateParameters = new UpdateTopologyParameters_js_1.UpdateTopologyParameters(chosenNode);
            updateParameters.timeoutInMs = 0;
    ...
    async _sendRequestToServer(chosenNode, nodeIndex, command, shouldRetry, sessionInfo, request, url, abortController) {
        try {
            ...
            if (!TypeUtil_js_1.TypeUtil.isNullOrUndefined(timeout)) {
                ...
                try {
                    ...
                    if (error.name === "AbortError") {
                        const timeoutException = (0, index_js_1.getError)("TimeoutException", "The request for " + request.uri + " failed with timeout after " + TimeUtil_js_1.TimeUtil.millisToTimeSpan(timeout), error);
                        if (!shouldRetry) {
            ...
            if (e?.cause?.code === "UNABLE_TO_VERIFY_LEAF_SIGNATURE") {
                if (chosenNode.url.startsWith("https://") && !this.getAuthOptions()?.certificate) {
                    (0, index_js_1.throwError)("AuthorizationException", "This server requires client certificate for authentication, but none was provided by the client.", e);
                }
            }
            ...
            if (e.code === "ERR_INVALID_PROTOCOL") {
                ...
                (0, index_js_1.throwError)("AuthorizationException", "Invalid protocol", e);
            }
            if (!shouldRetry) {
                throw e;
            }
    ...
    async _send(chosenNode, command, sessionInfo, request) {
        ...
        if (sessionInfo && sessionInfo.lastClusterTransactionIndex) {
            ...
            if (this._lastServerVersion && "4.1".localeCompare(this._lastServerVersion) > 0) {
                (0, index_js_1.throwError)("ClientVersionMismatchException", "The server on " + chosenNode.url + " has an old version and can't perform "
    ...
    _setRequestHeaders(sessionInfo, cachedChangeVector, req) {
        if (cachedChangeVector) {
            req.headers[Constants_js_1.HEADERS.IF_NONE_MATCH] = `"${cachedChangeVector}"`;
        }
        if (!this._disableClientConfigurationUpdates) {
            req.headers[Constants_js_1.HEADERS.CLIENT_CONFIGURATION_ETAG] = this._clientConfigurationEtag;
        }
        if (sessionInfo && sessionInfo.lastClusterTransactionIndex) {
            req.headers[Constants_js_1.HEADERS.LAST_KNOWN_CLUSTER_TRANSACTION_INDEX] =
                sessionInfo.lastClusterTransactionIndex;
        }
        if (!this._disableTopologyUpdates) {
            req.headers[this._topologyHeaderName] = `"${this._topologyEtag}"`;
        }
        if (!req.headers[Constants_js_1.HEADERS.CLIENT_VERSION]) {
            req.headers[Constants_js_1.HEADERS.CLIENT_VERSION] = RequestExecutor.CLIENT_VERSION;
        }
    }
    ...
    static _tryGetServerVersion(response) {
        return response.headers.get(Constants_js_1.HEADERS.SERVER_VERSION);
    }
    _throwFailedToContactAllNodes(command, req) {
        if (!command.failedNodes || !command.failedNodes.size) { //precaution, should never happen at this point
            (0, index_js_1.throwError)("InvalidOperationException", "Received unsuccessful response and couldn't recover from it. " +
        ...
        let message = "Tried to send "
            ...
            + "none of the attempt succeeded." + OsUtil_js_1.EOL;
        if (this._topologyTakenFromNode) {
            message += "I was able to fetch " + this._topologyTakenFromNode.database
                + " topology from " + this._topologyTakenFromNode.url + "." + OsUtil_js_1.EOL;
        }
        let nodes;
        if (this._nodeSelector && this._nodeSelector.getTopology()) {
        ...
        (0, index_js_1.throwError)("AllTopologyNodesDownException", message);
    }
    inSpeedTestPhase() {
        return this._nodeSelector
    ...
    async _executeOnAllToFigureOutTheFastest(chosenNode, command) {
        ...
        for (let i = 0; i < nodes.length; i++) {
            ...
            task = Promise.resolve()
                .then(() => {
                const req = this._createRequest(nodes[taskNumber], command, TypeUtil_js_1.TypeUtil.NOOP);
                if (!req) {
                    return;
                }
        ...
        const result = (0, PromiseUtil_js_1.raceToResolution)(tasks)
            .then(fastest => {
    ...
    _getFromCache(command, useCache, url, cachedItemMetadataCallback) {
        ...
        return new HttpCache_js_1.ReleaseCacheItem(null);
    }
    ...
    _createRequest(node, command, urlRef) {
        ...
        if (command.selectedNodeTag) {
            builder = RequestExecutor.appendToQuery(builder, Constants_js_1.QUERY_STRING.NODE_TAG, command.selectedNodeTag);
        }
        if (!TypeUtil_js_1.TypeUtil.isNullOrUndefined(command.selectedShardNumber)) {
            builder = RequestExecutor.appendToQuery(builder, Constants_js_1.QUERY_STRING.SHARD_NUMBER, command.selectedShardNumber);
        }
    ...
    static appendToQuery(builder, key, value) {
    ...
    async _handleUnsuccessfulResponse(chosenNode, nodeIndex, command, req, response, responseBodyStream, url, sessionInfo, shouldRetry) {
        ...
        const readBody = () => (0, StreamUtil_js_1.readToEnd)(responseBodyStream);
        switch (response.status) {
            ...
            case StatusCode_js_1.StatusCodes.Forbidden: {
                const msg = await readBody();
                (0, index_js_1.throwError)("AuthorizationException", `Forbidden access to ${chosenNode.database}@${chosenNode.url}`
                    + `, ${req.method || "GET"} ${req.uri}` + OsUtil_js_1.EOL + msg);
                break;
            }
            case StatusCode_js_1.StatusCodes.Gone: {
                ...
                if (command.isFailedWithNode(chosenNode)) {
                    command.failedNodes.set(chosenNode, (0, index_js_1.getError)("UnsuccessfulRequestException", "Request to " + url + "(" + req.method + ") is not relevant for this node anymore."));
                }
            ...
            case StatusCode_js_1.StatusCodes.GatewayTimeout:
            case StatusCode_js_1.StatusCodes.RequestTimeout:
            case StatusCode_js_1.StatusCodes.BadGateway:
            case StatusCode_js_1.StatusCodes.ServiceUnavailable: {
                return this._handleServerDown(url, chosenNode, nodeIndex, command, req, response, await readBody(), null, sessionInfo, shouldRetry);
            }
            case StatusCode_js_1.StatusCodes.Conflict: {
                return command.responseBehavior.tryHandleConflict(response, await readBody());
            }
            case StatusCode_js_1.StatusCodes.TooEarly: {
                if (!shouldRetry) {
                    return false;
                }
                if (!TypeUtil_js_1.TypeUtil.isNullOrUndefined(nodeIndex)) {
                    this._nodeSelector.onFailedRequest(nodeIndex);
                }
                command.failedNodes ??= new Map();
                if (!command.isFailedWithNode(chosenNode)) {
                    command.failedNodes.set(chosenNode, (0, index_js_1.getError)("UnsuccessfulRequestException", "Request to '" + req.uri + "' (" + req.method + ") is processing and not yet available on that node."));
                }
    ...
    async _broadcast(command, sessionInfo) {
        if (!command["prepareToBroadcast"]) {
            (0, index_js_1.throwError)("InvalidOperationException", "You can broadcast only commands that implement 'IBroadcast'.");
        }
        const broadcastCommand = command;
        const failedNodes = command.failedNodes;
        command.failedNodes = new Map(); // clean the current failures
    ...
    async _waitForBroadcastResult(command, tasks) {
        ...
        const exceptions = Array.from(command.failedNodes
            ...
            .join(", ");
        (0, index_js_1.throwError)("AllTopologyNodesDownException", "Broadcasting " + command.constructor.name + " failed: " + exceptions);
    }
    ...
    async handleServerNotResponsive(url, chosenNode, nodeIndex, e) {
        ...
        if (this._disableTopologyUpdates) {
            ...
            const updateParameters = new UpdateTopologyParameters_js_1.UpdateTopologyParameters(preferredNode.currentNode);
            updateParameters.timeoutInMs = 0;
    ...
    _spawnHealthChecks(chosenNode) {
        ...
        const nodeStatus = new NodeStatus(chosenNode, this, (nStatus) => this._checkNodeStatusCallback(nStatus));
    ...
    _checkNodeStatusCallback(nodeStatus) {
        ...
        if (!serverNode || TypeUtil_js_1.TypeUtil.isNullOrUndefined(nodeIndex)) {
            return;
        }
    ...
    static _readExceptionFromServer(req, response, body, e) {
        if (response && body) {
            ...
            try {
                const resExceptionSchema = Serializer_js_1.JsonSerializer
                    .getDefaultForCommandPayload()
                    .deserialize(responseJson);
                return index_js_1.ExceptionDispatcher.get(resExceptionSchema, response.status, e);
            }
            catch (__) {
                ...
                return index_js_1.ExceptionDispatcher.get(unrecognizedErrSchema, response.status, e);
            }
        }
        ...
        return index_js_1.ExceptionDispatcher.get(exceptionSchema, StatusCode_js_1.StatusCodes.ServiceUnavailable, e);
    }
    _setDefaultRequestOptions() {
        this._defaultRequestOptions = Object.assign(DEFAULT_REQUEST_OPTIONS, this._customHttpRequestOptions);
    }
    dispose() {
        ...
        this._disposed = true;
        this._updateClientConfigurationSemaphore.take(TypeUtil_js_1.TypeUtil.NOOP);
        this._updateDatabaseTopologySemaphore.take(TypeUtil_js_1.TypeUtil.NOOP);
        this._cache.dispose();
    ...
    async getRequestedNode(nodeTag, throwIfContainsFailures = false) {
        ...
        if (throwIfContainsFailures && !this._nodeSelector.nodeIsAvailable(currentIndexAndNode.currentIndex)) {
            (0, index_js_1.throwError)("RequestedNodeUnavailableException", "Requested node " + nodeTag + " currently unavailable, please try again later.");
        }
    ...
    async _ensureNodeSelector() {
        ...
        if (!this._nodeSelector) {
            const topology = new Topology_js_1.Topology(this._topologyEtag, this.getTopologyNodes().slice());
            this._nodeSelector = new NodeSelector_js_1.NodeSelector(topology);
        }
    }
    _onTopologyUpdatedInvoke(newTopology, reason) {
        this._emitter.emit("topologyUpdated", new SessionEvents_js_1.TopologyUpdatedEventArgs(newTopology, reason));
    }
}
